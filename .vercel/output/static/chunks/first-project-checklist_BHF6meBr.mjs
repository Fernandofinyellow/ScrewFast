...
const file = "/workspaces/ScrewFast/src/content/docs/es/guides/first-project-checklist.mdx";
...
Content.moduleId = "/workspaces/ScrewFast/src/content/docs/es/guides/first-project-checklist.mdx";
