...
const file = "/workspaces/ScrewFast/src/content/docs/ja/guides/getting-started.mdx";
...
Content.moduleId = "/workspaces/ScrewFast/src/content/docs/ja/guides/getting-started.mdx";
