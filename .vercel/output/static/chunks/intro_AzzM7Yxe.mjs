...
import { m as $$Tabs, n as $$TabItem } from './Code_CoBFoX8Y.mjs';
import 'clsx';
...
const file = "/workspaces/ScrewFast/src/content/docs/zh-cn/guides/intro.mdx";
...
Content.moduleId = "/workspaces/ScrewFast/src/content/docs/zh-cn/guides/intro.mdx";
