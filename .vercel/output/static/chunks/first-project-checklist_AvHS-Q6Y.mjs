...
const file = "/workspaces/ScrewFast/src/content/docs/fr/guides/first-project-checklist.mdx";
...
Content.moduleId = "/workspaces/ScrewFast/src/content/docs/fr/guides/first-project-checklist.mdx";
