...
const file = "/workspaces/ScrewFast/src/content/docs/fa/guides/first-project-checklist.mdx";
...
Content.moduleId = "/workspaces/ScrewFast/src/content/docs/fa/guides/first-project-checklist.mdx";
