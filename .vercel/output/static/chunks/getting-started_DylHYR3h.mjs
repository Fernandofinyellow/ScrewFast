...
const file = "/workspaces/ScrewFast/src/content/docs/guides/getting-started.mdx";
...
Content.moduleId = "/workspaces/ScrewFast/src/content/docs/guides/getting-started.mdx";
