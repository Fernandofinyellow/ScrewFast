...
const file = "/workspaces/ScrewFast/src/content/docs/fr/guides/getting-started.mdx";
...
Content.moduleId = "/workspaces/ScrewFast/src/content/docs/fr/guides/getting-started.mdx";
