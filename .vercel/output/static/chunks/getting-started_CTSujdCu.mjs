...
const file = "/workspaces/ScrewFast/src/content/docs/de/guides/getting-started.mdx";
...
Content.moduleId = "/workspaces/ScrewFast/src/content/docs/de/guides/getting-started.mdx";
