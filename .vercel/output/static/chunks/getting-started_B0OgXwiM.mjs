...
const file = "/workspaces/ScrewFast/src/content/docs/es/guides/getting-started.mdx";
...
Content.moduleId = "/workspaces/ScrewFast/src/content/docs/es/guides/getting-started.mdx";
