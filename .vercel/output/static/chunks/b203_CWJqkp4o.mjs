const id = "b203.md";
						...
						new Proxy({"src":"/_astro/product-image-3.BNT8XmJo.avif","width":1458,"height":1042,"format":"avif","fsPath":"/workspaces/ScrewFast/src/images/product-image-3.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/workspaces/ScrewFast/src/images/product-image-3.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/workspaces/ScrewFast/src/images/product-image-3.avif");
							return target[name];
						}
					})
					,imgMain:
						new Proxy({"src":"/_astro/product-image-main-3.CZjWzLDc.avif","width":1909,"height":934,"format":"avif","fsPath":"/workspaces/ScrewFast/src/images/product-image-main-3.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/workspaces/ScrewFast/src/images/product-image-main-3.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/workspaces/ScrewFast/src/images/product-image-main-3.avif");
							return target[name];
						}
					})
					...
					,second:
						...
						const _internal = {
							type: 'content',
							filePath: "/workspaces/ScrewFast/src/content/products/b203.md",
							rawData: undefined,
						};
